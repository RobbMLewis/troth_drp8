...
/**
 * Access Control Handler for TrothGoogleGroupEntity.
 */
class TrothGoogleEntityAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\troth_google\Entity\TrothGoogleGroupEntityInterface $entity */
