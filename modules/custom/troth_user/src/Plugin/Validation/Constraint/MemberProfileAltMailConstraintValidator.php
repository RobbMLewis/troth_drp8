...
/**
 * Validates the MemberProfileAltMail constraint.
 */
class MemberProfileAltMailConstraintValidator extends ConstraintValidator {
  ...
  public function validate($entity, Constraint $constraint) {
    ...
    $or = $query->orConditionGroup()
      ->condition('mail', $altMail, 'like')
      ->condition('field_profile_alt_email', $altMail, 'like');
    $query->condition($or);
    $uids = $query->execute();
    if (count($uids) > 0) {
